...
Tag.prototype.toVersion = function(options) {
  ...
  var appendHash = options.appendHash !== undefined ? options.appendHash : false;
  ...
  if (this.onTop || (this.hash && appendHash)) { v += '+' + this.onTop };
  if (this.hash && appendHash) { v += '.' + this.hash };
  return v;
}
